...
Vue.component("purple_header_component_1721735177", {
    template: `
    <div>
        ...
        <div class="flex">
            <aside class="w-64 h-screen bg-navy-900 text-white p-4 fixed left-0 top-0 bottom-0 z-10">
                <nav>
                    <ul>
            ...
            <main class="flex-1 bg-black ml-64">
